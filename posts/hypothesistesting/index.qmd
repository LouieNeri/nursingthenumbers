...
Starting to conduct hypothesis testing is when you really start to feel like a scientist. You're usually given this framework for testing hypotheses, called Null Hypothesis Significance Testing (NHST). It goes something like this:
...
Now, this process has been largely critiqued. One of them, being the Bayesians who feel that frequentist statistics is the root of all evil. Another critique from the more conventional/frequentist statisticians who say that it is simply a misrepresentation of how this process was initially developed. I'm a statistical agnostic, and find myself more in the latter camp in this whole debacle.
...
1.  Set up two hypotheses, your main hypothesis (usually nil, but can be anything) and the alternative hypothesis, and decide your $\alpha$ (false positive) and $\beta$ (false negative) levels before hand, which defines your rejection region.
...
In the Neyman-Pearson approach, there is a hard cutoff determined ahead of time, to create a binary decision, allowing you to act as if a hypothesis were true. The hard cutoff requires some thinking on your end, and really depends on your scenario.

# The Frankenstein combination of the two

After learning about the Fisher and Neyman-Pearson approaches, you'll see some similarities between the two and NHST. Let's look at them again:
