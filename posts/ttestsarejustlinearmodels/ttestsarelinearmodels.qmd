...
-   $\hat{y}$ represents is the estimated dependent variable, in this case, vertical jump height.
...
-   $\hat{\beta}_1x$ represents the estimated slope coefficient, which tell us that how much y changes, on average, for a one-unit increase in x.

What you'll see in a moment, is that fitting a regression line using this binary predictor is the same as doing a two sample t-test.

Let's compute the simple linear regression!
...
-   The slope coefficient: Now, let's look at $\hat{\beta}_1$, our slope from the regression. It's 3.0058. Here's where it gets interesting. Grab your t-test results: • Red shoe group mean: 29.76422 • Blue shoe group mean: 26.75480 Do a quick subtraction: 29.76422 - 26.75480 = 3.00582 Look familiar? It's our regression slope!
